...
import 'package:trackdeal/view/post_a_coupon/submit_coupon4.dart';
import 'package:trackdeal/view/post_a_deal/submit_deal4.dart';

import '../../customWidgets/custom_button.dart';

class SubmitCoupon3 extends StatefulWidget {
  const SubmitCoupon3({super.key});

  @override
  State<SubmitCoupon3> createState() => _SubmitCoupon3State();
}

class _SubmitCoupon3State extends State<SubmitCoupon3> {
        ...
        bottomNavigationBar: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SubmitCoupon4(),));
                },
                child: Container(
                  height: 45..h,
                  width: 130..w,
