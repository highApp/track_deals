...
import 'package:trackdeal/view/post_a_coupon/submit_coupon5.dart';
import 'package:trackdeal/view/post_a_deal/submit_deal2.dart';
import 'package:trackdeal/view/post_a_deal/submit_deal5.dart';

class SubmitCoupon4 extends StatefulWidget {
  const SubmitCoupon4({super.key});

  @override
  State<SubmitCoupon4> createState() => _SubmitCoupon4State();
}

class _SubmitCoupon4State extends State<SubmitCoupon4> {
  @override
        ...
        bottomNavigationBar: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SubmitCoupon5(),));
                },
                child: Container(
                  height: 45..h,
                  width: 130..w,
