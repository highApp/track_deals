...
import 'package:trackdeal/view/post_a_coupon/submit_coupon3.dart';


class SubmitCoupon2 extends StatefulWidget {
  const SubmitCoupon2({super.key});

  @override
  State<SubmitCoupon2> createState() => _SubmitCoupon2State();
}

class _SubmitCoupon2State extends State<SubmitCoupon2> {

  bool isOnlineSelected = true;
  String selected = "Discount (%)"; // default selected
  final List<String> options = ["Discount (%)", "Reduction (%)", "Free Shipping", "Others"];
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => SubmitCoupon3(),));
                      },
                      child: Container(
                        height: 45..h,
                        width: 130..w,
